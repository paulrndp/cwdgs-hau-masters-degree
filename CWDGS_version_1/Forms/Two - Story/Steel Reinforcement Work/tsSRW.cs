using CWDGS_version_1.Forms.Two___Story.Steel_Reinforcement_Work;
using System;
...
{
    public partial class tsSRW : Form
    {
        public tsSRW()
        {
            InitializeComponent();
   ...
   
     {
            ...
            try
            {
                ...
                decimal SCweight = Convert.ToDecimal(txtSCWeight.Text);
                decimal staircase = Convert.ToDecimal(txtStairCase.Text);

                decimal SCdays = Convert.ToDecimal(txtSCDays.Text);

                decimal a = (SCweight / (SCworkers * staircase));
        ...
        private void StairCaseTwo()
        {
            ...
            try
            {
                decimal a = (SCweight / (SCpreffered * staircase));
                SCworkers = (int)Math.Ceiling(a);
                txtSCWorkers.Text = SCworkers.ToString();
                txtSCSteelMan.Text = SCworkers.ToString();
                StairCaseOne();
                SCCostOfLabor();
        ...
        private void SCCostOfLabor()
        {
            ...
            int SCsteelman = Convert.ToInt32(txtSCSteelMan.Text);

            try
            {
                int a = costOfLabor * SCdays * SCsteelman;
        ...
        private void txtSCWeight_TextChanged(object sender, EventArgs e)
        {
            if (txtSCWeight.Text == "" || txtSCWeight.Text == "0" || txtSCPreffered.Text == "" || txtSCPreffered.Text == "0" )
            {
        ...
        {
            tsStairCase sc = new tsStairCase();
            sc.ShowDialog();
