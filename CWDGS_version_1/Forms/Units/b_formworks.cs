...
{
    public partial class b_formworks : Form
    {
        ...
        private void getInformation()
        {
            units_database();
            //ID
            string IDquery = "select id from b_formworks";
            ...
            //VALUES
            string ValueQuery = "select square_meter_per_day from b_formworks";
        ...
        private void update()
        {
            ...
            {
                units_database();
                string Query = "update b_formworks " +
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Formworks have been updated successfully.", "Construction Worker Distribution Guide System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                update();
                this.Hide();
            }
        }
        ...
        private void b_formworks_Load(object sender, EventArgs e)
        {
            getInformation();
        }
    }
